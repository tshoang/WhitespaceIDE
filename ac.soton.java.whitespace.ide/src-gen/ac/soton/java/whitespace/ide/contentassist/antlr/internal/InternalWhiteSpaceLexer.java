...
public class InternalWhiteSpaceLexer extends Lexer {
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            // InternalWhiteSpace.g:3841:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalWhiteSpace.g:3841:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalWhiteSpace.g:3841:24: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_SPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhiteSpace.g:3843:12: ( ' ' )
            // InternalWhiteSpace.g:3843:14: ' '
            {
            match(' '); 
    ...
    public final void mRULE_TAB() throws RecognitionException {
        try {
            int _type = RULE_TAB;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhiteSpace.g:3845:10: ( '\\t' )
            // InternalWhiteSpace.g:3845:12: '\\t'
            {
            match('\t'); 
    ...
    public final void mRULE_LF() throws RecognitionException {
        try {
            int _type = RULE_LF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhiteSpace.g:3847:9: ( '\\n' )
            // InternalWhiteSpace.g:3847:11: '\\n'
            {
            match('\n'); 
    ...
    public final void mRULE_NOTWS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalWhiteSpace.g:3849:12: ( (~ ( ( ' ' | '\\t' | '\\n' ) ) )+ )
            // InternalWhiteSpace.g:3849:14: (~ ( ( ' ' | '\\t' | '\\n' ) ) )+
            {
            // InternalWhiteSpace.g:3849:14: (~ ( ( ' ' | '\\t' | '\\n' ) ) )+
            int cnt2=0;
            loop2:
